            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="dropdown">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown">
                        <c:choose>
                            <c:when test="${not empty usuarioLogado.foto_perfil}">
                                <img src="<c:url value='${usuarioLogado.foto_perfil}'/>" alt="User" class="user-profile-img me-2">
                            </c:when>
                            <c:otherwise>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <canvas id="candidaturasChart" height="250"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
